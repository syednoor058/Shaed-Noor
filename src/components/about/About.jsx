...
export default function About() {
  return (
    <>
      <div className="w-full bg-[#dae85e] px-7 sml:px-9 py-10 md:px-12 lg:px-20 lg:py-20 flex flex-col-reverse lg:flex-row overflow-hidden gap-10 lg:gap-0 justify-center items-center">
        ...
        <div className="w-full lg:w-[50%]">
          <div className="w-full flex flex-col gap-7 lg:gap-10">
            ...
            <div className="flex flex-row">
              ...
              <div className="w-full lg:w-[75%] text-sm md:text-base text-end lg:text-end">
            ...
            <div className="flex flex-row">
              <div className="w-[50%] flex justify-center items-center">
                <a className="flex justify-center items-center px-5 py-2 text-sm md:text-base text-lightText bg-darkAccent rounded cursor-pointer hover:scale-[1.1] duration-[400ms]">
                  Learn More{" "}
