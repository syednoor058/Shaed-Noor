...
export default function TestimonialCard(props) {
  return (
    <div>
      <div className="w-[380px] aspect-video md:w-[450px] lg:w-[500px] mx-5 my-3 p-5 rounded-md flex flex-col gap-2 justify-center bg-darkBG3 overflow-hidden bg-opacity-70">
