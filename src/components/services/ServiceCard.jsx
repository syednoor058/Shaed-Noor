...
export default function ServiceCard(props) {
  return (
    <div className="flex flex-col gap-2 md:gap-3 p-3 sml:p-3 md:p-5 lg:hover:border bg-gradient-to-br from-primaryColor1 to-accentColor1 hover:bg-gradient-to-t hover:from-darkBG1 hover:to-darkBG1 rounded-md hover:scale-[1.05] duration-[400ms] shadow-xl cursor-pointer group justify-center ">
