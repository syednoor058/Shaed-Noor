...
export default function Services() {
  return (
    <div id="services">
      <div className="w-full px-7 sml:px-9 py-10 md:px-12 lg:px-20 lg:py-20 overflow-hidden flex flex-col gap-7 lg:gap-10 bg-darkBG3">
        ...
        <div className="flex flex-row justify-between">
          <div className="w-full">
            <div className="w-full h-full grid grid-cols-1 sml:grid-cols-2 lg:grid-cols-3 gap-5 xl:gap-10">
              <ServiceCard
                icon=<FaCode />
